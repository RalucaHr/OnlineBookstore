...
(function ($) {
    ...
    //    min: 1,
    //    max: 100,
    //    //document.getElementById('minPriceCached').value
    //    //document.getElementById('maxPriceCached').value
    //    values: [document.getElementById('minPriceCached').value, document.getElementById('maxPriceCached').value],
